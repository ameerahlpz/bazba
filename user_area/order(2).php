...
@session_start();							//paste from last night
...
$status='pending';
			...
			//from cart_details INNER JOIN products ON cart_details.product_id=products.product_ID";
...
$insert_complete_orders_products="Select * FROM products JOIN cart_details ON products.product_ID=cart_details.product_id";		
$conn=mysqli_connect("localhost", "root", "", "bazbastore");
